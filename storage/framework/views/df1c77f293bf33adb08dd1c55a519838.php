...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Administrator Kampus</title>
...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="nav-item">
            <a href="/admin/faculties" class="nav-link <?php echo e(request()->is('admin/faculties*') ? 'active' : ''); ?>">
                <i class="bi bi-building"></i> Fakultas
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/prodis" class="nav-link <?php echo e(request()->is('admin/prodis*') ? 'active' : ''); ?>">
                <i class="bi bi-mortarboard"></i> Program Studi
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/accreditations/create" class="nav-link <?php echo e(request()->is('admin/accreditations*') ? 'active' : ''); ?>">
                <i class="bi bi-award"></i> Akreditasi
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/organization" class="nav-link <?php echo e(request()->is('admin/organization*') ? 'active' : ''); ?>">
        ...
        <div class="nav-item">
            <a href="/admin/posts" class="nav-link <?php echo e(request()->is('admin/posts*') ? 'active' : ''); ?>">
                <i class="bi bi-newspaper"></i> Berita & Artikel
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/sliders" class="nav-link <?php echo e(request()->is('admin/sliders*') ? 'active' : ''); ?>">
                <i class="bi bi-images"></i> Slider Banner
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.profiles.index', 1)); ?>" class="nav-link <?php echo e(request()->is('admin/profiles*') ? 'active' : ''); ?>">
                <i class="bi bi-bank"></i> Profil Kampus
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/partners" class="nav-link <?php echo e(request()->is('admin/partners*') ? 'active' : ''); ?>">
                <i class="bi bi-briefcase"></i> Mitra & Partner
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/badges" class="nav-link <?php echo e(request()->is('admin/badges*') ? 'active' : ''); ?>">
                <i class="bi bi-award"></i> Gelar & Slogan
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/facilities" class="nav-link <?php echo e(request()->is('admin/facilities*') ? 'active' : ''); ?>">
        ...
        <div class="nav-item">
            <a href="/admin/pmb-info" class="nav-link <?php echo e(request()->is('admin/pmb*') ? 'active' : ''); ?>">
                <i class="bi bi-megaphone"></i> Info PMB
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/alumni" class="nav-link <?php echo e(request()->is('admin/alumni*') ? 'active' : ''); ?>">
                <i class="bi bi-people"></i> Data Alumni
            </a>
        </div>
        <div class="nav-item">
            <a href="/admin/admissions" class="nav-link <?php echo e(request()->is('admin/admissions*') ? 'active' : ''); ?>">
        ...
        <div class="nav-item">
            <a href="/admin/guides" class="nav-link <?php echo e(request()->is('admin/guide*') ? 'active' : ''); ?>">
...
<div class="main-wrapper">
    ...
    <header class="top-navbar">
        ...
        <h5 class="m-0 fw-bold text-dark d-none d-lg-block"><?php echo $__env->yieldContent('title'); ?></h5>
            ...
            <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle text-dark" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="flex flex-col">
                    <span class="text-xl font-extrabold text-sky-600 tracking-wide leading-none">
                        <?php echo e($profile->campus_name ?? 'KampusGW University'); ?>
...
</html><?php /**PATH C:\laragon\www\kampus_anda\resources\views\admin\layout\main.blade.php ENDPATH**/ ?>