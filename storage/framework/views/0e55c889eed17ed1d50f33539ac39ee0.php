<nav x-data="{ mobileMenuOpen: false }" class="fixed top-0 left-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 transition-all duration-300">
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <a href="/" class="flex items-center gap-3 group">
            <?php if(isset($profile) && $profile->logo_path): ?>
            ...
            <div class="flex flex-col">
                <span class="text-xl font-black text-sky-600 tracking-tight leading-none uppercase">
                    <?php echo e($profile->campus_name ?? 'KampusGW'); ?>

                </span>
                <span class="text-[10px] font-bold text-slate-400 tracking-[0.2em] uppercase mt-1">
                    <?php echo e($profile->tagline ?? 'Tagline Kampus Anda'); ?>
        ...
        <div class="hidden md:flex items-center gap-1 text-sm font-bold text-slate-600">
                ...
                <ul class="absolute top-full left-0 w-64 bg-white border border-slate-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top translate-y-2 group-hover:translate-y-0 p-2 z-50">
                    ...
                    <li class="relative group/sub">
                        ...
                        <ul class="absolute top-0 left-full ml-2 w-64 bg-white border border-slate-100 rounded-2xl shadow-xl opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all p-2">
                            ...
                            <li><a href="<?php echo e(route('tentang.fasilitas.umum')); ?>" class="block px-4 py-2 rounded-lg bg-sky-50 text-sky-600 font-bold hover:bg-sky-600 hover:text-white transition mb-2">Fasilitas Umum</a></li>
                            ...
                            <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('tentang.fasilitas.faculty', $faculty->slug)); ?>" class="block px-4 py-2 rounded-lg hover:bg-sky-600 hover:text-white transition"><?php echo e($faculty->name); ?></a></li>
            ...
            <div class="relative group h-20 flex items-center">
                ...
                <ul class="absolute top-full left-0 w-64 bg-white border border-slate-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top translate-y-2 group-hover:translate-y-0 p-2 z-50">
                        ...
                        <li class="relative group/prodi">
                            ...
                            <ul class="absolute top-0 left-full ml-2 w-64 bg-white border border-slate-100 rounded-2xl shadow-xl opacity-0 invisible group-hover/prodi:opacity-100 group-hover/prodi:visible transition-all p-2 max-h-80 overflow-y-auto">
                                <?php $__empty_1 = true; $__currentLoopData = $faculty->prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li><a href="<?php echo e(route('faculties.prodis.show', [$faculty->slug, $prodi->slug])); ?>" class="block px-4 py-2 rounded-lg hover:bg-sky-600 hover:text-white transition text-xs"><?php echo e($prodi->name); ?></a></li>
                    ...
                    <li class="relative group/prodi"> 
                        <div class="flex justify-between items-center px-4 py-2.5 rounded-xl hover:bg-sky-600 hover:text-white cursor-pointer transition">
                            <a href="<?php echo e(route('downloads.index')); ?>">Dokumen Akademik</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="relative group h-20 flex items-center">
                ...
                <ul class="absolute top-full left-0 w-56 bg-white border border-slate-100 rounded-2xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top translate-y-2 group-hover:translate-y-0 p-2 z-50">
                    ...
                    <?php $__currentLoopData = $navCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="/posts?category=<?php echo e($category->slug); ?>" class="block px-4 py-2.5 rounded-xl hover:bg-sky-600 hover:text-white transition">
        ...
        <div class="p-6 space-y-3">
                ...
                <div x-show="open" x-collapse class="pl-4 mt-2 space-y-2 bg-slate-50 rounded-2xl p-2">
                    ...
                    <div x-data="{ openFas: false }" class="border-t border-slate-200/50 pt-2">
                        ...
                        <div x-show="openFas" x-collapse class="pl-4 mt-1 space-y-1">
                            ...
                            <a href="<?php echo e(route('tentang.fasilitas.umum')); ?>" class="block px-4 py-2 text-xs font-black bg-sky-600 text-white rounded-lg text-center shadow-sm">
                            ...
                            <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('tentang.fasilitas.faculty', $faculty->slug)); ?>" class="block px-4 py-1.5 text-xs text-slate-500 hover:text-sky-600 border-l-2 border-slate-200 ml-2">
                                    <?php echo e($faculty->name); ?>
                    ...
                    <?php $__currentLoopData = $faculties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faculty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-data="{ openProdi: false }" class="mb-1">
                            ...
                            <div x-show="openProdi" x-collapse class="pl-4 ml-2 border-l-2 border-sky-200 space-y-1 mt-1">
                                <?php $__currentLoopData = $faculty->prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('faculties.prodis.show', [$faculty->slug, $prodi->slug])); ?>" class="block px-4 py-1.5 text-xs text-slate-500 font-medium hover:text-sky-600"><?php echo e($prodi->name); ?></a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div x-data="{ openNews: false }">
                ...
                <div x-show="openNews" x-collapse class="pl-4 mt-2 space-y-2 bg-slate-50 rounded-2xl p-2">
                    ...
                    <?php $__currentLoopData = $navCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="/posts?category=<?php echo e($category->slug); ?>" class="block px-4 py-2 text-sm font-semibold text-slate-600 hover:text-sky-600">
                            <?php echo e($category->name); ?>
...
</style><?php /**PATH C:\laragon\www\kampus_anda\resources\views/layout/navbar.blade.php ENDPATH**/ ?>