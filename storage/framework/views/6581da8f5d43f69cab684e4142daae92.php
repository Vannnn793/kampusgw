<?php $__env->startSection('title', 'Sambutan Rektor'); ?>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight tracking-tight animate-fade-up">
            ...
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-200 to-white">
                <?php echo e($profile->campus_name ?? 'Kampus Kami'); ?>
        ...
        <div class="grid lg:grid-cols-12 gap-12 items-start">
                ...
                <div class="sticky top-32">
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative bg-white rounded-[2rem] p-3 shadow-2xl shadow-sky-900/10 border border-white">
                            <div class="rounded-[1.5rem] overflow-hidden aspect-[3/4] relative bg-slate-100">
                                <?php if($rektor && $rektor->foto_rektor): ?>
                                    <img 
                                        src="<?php echo e(asset('storage/' . $rektor->foto_rektor)); ?>" 
                                        alt="<?php echo e($rektor->nama_rektor); ?>"
                    ...
                    <div class="text-center mt-8">
                        <h2 class="text-2xl font-black text-slate-800 mb-1">
                            <?php echo e($rektor->nama_rektor ?? 'Nama Rektor'); ?>

                        </h2>
                        <p class="text-sky-600 font-bold uppercase tracking-widest text-sm mb-4">
                            Rektor <?php echo e($profile->campus_name ?? 'Universitas'); ?>
            ...
            <div class="lg:col-span-8" data-aos="fade-up">
                ...
                <div class="bg-white rounded-[2.5rem] p-8 md:p-12 border border-sky-100 shadow-xl shadow-sky-100/50 relative overflow-hidden">
                    ...
                    <?php if($rektor && $rektor->logo_path): ?>
                    <img src="<?php echo e(asset('storage/' . $rektor->logo_path)); ?>" 
                    ...
                    <div class="prose prose-lg prose-slate max-w-none 
                        ...
                        <?php if($rektor && $rektor->sambutan_rektor): ?>
                            <?php echo $rektor->sambutan_rektor; ?>
                    ...
                    <div class="mt-16 pt-10 border-t border-slate-100 flex flex-col items-end text-right">
                        ...
                        <p class="text-slate-400 text-sm mb-6"><?php echo e(date('F Y')); ?></p>
                        
                        <?php if($rektor && $rektor->logo_path): ?>
                            
                            <img src="<?php echo e(asset('storage/' . $rektor->logo_path)); ?>" class="h-16 w-auto mb-4 opacity-80" alt="Logo">
                        <?php endif; ?>

                        <h4 class="font-bold text-slate-800 text-lg"><?php echo e($rektor->nama_rektor ?? 'Nama Rektor'); ?></h4>
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kampus_anda\resources\views/tentang/sambutan.blade.php ENDPATH**/ ?>