            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane show active" id="stats" role="tabpanel">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6"><label class="form-label fw-semibold">Tahun Beroperasi</label><input type="text" name="tahun_beroperasi" class="form-control" value="<?php echo e($profile->tahun_beroperasi); ?>"></div>
                                <div class="col-md-6"><label class="form-label fw-semibold">Total Program Studi</label><input type="text" name="total_prodi" class="form-control" value="<?php echo e($profile->total_prodi); ?>"></div>
                                <div class="col-md-6"><label class="form-label fw-semibold">Total Alumni</label><input type="text" name="total_alumni" class="form-control" value="<?php echo e($profile->total_alumni); ?>"></div>
                                <div class="col-md-6"><label class="form-label fw-semibold">Total Dosen</label><input type="text" name="total_dosen" class="form-control" value="<?php echo e($profile->total_dosen); ?>"></div>
                                <div class="col-md-6"><label class="form-label fw-semibold">Mahasiswa Aktif</label><input type="text" name="mahasiswa_aktif" class="form-control" value="<?php echo e($profile->mahasiswa_aktif); ?>"></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama_rektor" class="form-control" value="<?php echo e($profile->nama_rektor); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Isi Sambutan</label>
                                        <textarea name="sambutan_rektor" class="form-control summernote"><?php echo e($profile->sambutan_rektor); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="mb-3 position-relative overflow-hidden rounded bg-white shadow-sm" style="height: 250px;">
                                                <?php if($profile->foto_rektor): ?>
                                                    <img src="<?php echo e(asset('storage/'.$profile->foto_rektor)); ?>" id="preview-img" class="w-100 h-100 object-fit-cover">
                                                <?php else: ?>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <textarea name="sejarah_kampus" class="form-control summernote"><?php echo e($profile->sejarah_kampus); ?></textarea>
                            </div>
                            <div class="bg-light p-3 rounded border">
                                <label class="form-label fw-bold"><i class="bi bi-youtube text-danger me-2"></i>Link Video Profil (Youtube)</label>
                                <input type="text" name="link_video_profil" class="form-control" value="<?php echo e($profile->link_video_profil); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="visimisi" role="tabpanel">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4"><label class="form-label fw-bold">Visi</label><textarea name="visi" class="form-control summernote"><?php echo e($profile->visi); ?></textarea></div>
                            <div><label class="form-label fw-bold">Misi</label><textarea name="misi" class="form-control summernote"><?php echo e($profile->misi); ?></textarea></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="kontak" role="tabpanel">
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-6 mb-3"><label class="form-label fw-bold">Email</label><input type="email" name="email" class="form-control" value="<?php echo e($profile->email); ?>"></div>
                                <div class="col-md-6 mb-3"><label class="form-label fw-bold">No. Telepon</label><input type="text" name="phone" class="form-control" value="<?php echo e($profile->phone); ?>"></div>
                                <div class="col-12 mb-4">
                                    <label class="form-label fw-bold">Alamat Lengkap</label>
                                    <textarea name="address" id="address" class="form-control" rows="3"><?php echo e($profile->address); ?></textarea>
                                </div>
                                <div class="col-12">
