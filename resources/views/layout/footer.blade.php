    ...
    <div class="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-4 gap-10 text-sm">
        ...
        <div class="space-y-4">
            ...
            <p class="text-slate-500 leading-relaxed">
                {{-- Bisa ambil potongan Visi, atau hardcode slogan --}}
                {{-- Kita batasi textnya biar ga kepanjangan di footer --}}
                {{ Str::limit($profile->visi ?? 'Mencetak talenta global dengan kurikulum berbasis industri dan teknologi terkini.', 100) }}
            </p>
