        ...
        <div class="col-lg-10 col-xl-8">
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb bg-light p-3 rounded-pill shadow-sm px-4" style="--bs-breadcrumb-divider: '›';">
                    ...
                    <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">{{ $page->title }}</li>
                </ol>
            </nav>

            <header class="mb-5 text-center">
                <h1 class="display-4 fw-extrabold text-dark mb-3" style="letter-spacing: -1px;">{{ $page->title }}</h1>
...
<style>
    /* Custom Styling untuk elemen di dalam {!! $page->content !!} */
