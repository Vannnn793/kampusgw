@extends('layout.main')
@section('title', 'Bagikan Cerita Alumni')
...
<div class="relative py-20 overflow-hidden">
    <div class="absolute inset-0">
        <img src="{{ asset('storage/images/kampusgw.jpg') }}" class="w-full h-full object-cover opacity-30 transform scale-105 animate-slow-zoom" alt="Background">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                {{-- Icon Panah (Biar user tau ini dropdown) --}}
                        ...
                        <div>
                            ...
                            <input type="number" name="tahun_lulus" min="1900" max="{{ date('Y') }}" class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-sky-500/10 focus:border-sky-500 transition-all outline-none" placeholder="Contoh: 2023" required>
                        </div>
                        ...
                        {{-- Wrapper ini yang bakal muncul/hilang --}}
