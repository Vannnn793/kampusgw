                ...
                <form action="{{ route('admin.organization.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select name="category" id="category_select_create" class="form-select" required>
                                ...
                                <option value="pimpinan_univ" {{ old('category') == 'pimpinan_univ' ? 'selected' : '' }}>Pimpinan Universitas</option>
                                <option value="pimpinan_fakultas" {{ old('category') == 'pimpinan_fakultas' ? 'selected' : '' }}>Pimpinan Fakultas</option>
                                <option value="pimpinan_prodi" {{ old('category') == 'pimpinan_prodi' ? 'selected' : '' }}>Pimpinan Prodi</option>
                                <option value="dosen" {{ old('category') == 'dosen' ? 'selected' : '' }}>Dosen</option>
                                <option value="staff" {{ old('category') == 'staff' ? 'selected' : '' }}>Staf</option> 
                            </select>
                        </div>
                    </div>
                    {{-- Posisi --}}
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="position" class="form-control" placeholder="Contoh: Dekan, Kaprodi, dll." value="{{ old('position') }}" required>
                        </div>
                    </div>
