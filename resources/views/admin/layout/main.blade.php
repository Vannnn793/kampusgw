...
<div class="d-flex min-vh-100">
    ...
    <aside class="sidebar p-4">
        ...
        <a href="/admin/sliders"><i class="bi bi-images me-2"></i>Slider</a>
        <a href="{{ route('admin.profiles.index', 1) }}"><i class="bi bi-building me-2"></i>Profile Kampus</a>
        ...
        <a href="/admin/download"><i class="bi bi-download me-2"></i>Download</a>
        <a href="/admin/pmb-info"><i class="bi bi-people me-2"></i>pmb</a>
