...
<div class="container-fluid p-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.taglines.index') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    <form action="{{ route('admin.taglines.store') }}" method="POST">
                        @csrf
                        ...
                        {{-- 3. INPUT KODE MANUAL (BISA DIEDIT) --}}
                        <div class="mb-4">
