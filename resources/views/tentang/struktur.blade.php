...
<section class="py-16 section-bg">
    <div class="max-w-5xl mx-auto px-6 text-center" data-aos="fade-down">
...
<div class="max-w-7xl mx-auto px-6">
    ...
    {{-- ===== NOMOR 1 (ATAS) ===== --}}
    @if($top)
    <div class="box rounded-2xl overflow-hidden max-w-lg mx-auto mb-16"
         data-aos="zoom-in">

        <img src="{{ asset('storage/'.$top->photo) }}"
             class="w-full h-80 object-contain bg-sky-100">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="box rounded-2xl overflow-hidden flex flex-col"
             data-aos="fade-up">

            <img src="{{ asset('storage/'.$row->photo) }}"
                 class="w-full h-72 object-contain bg-sky-100">
