...
<section class="bg-slate-50 relative z-20 -mt-20 rounded-t-[3rem] min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-6 pt-20 pb-24">
        ...
        {{-- MAIN LAYOUT: Grid Kiri (PMB) & Kanan (Sidebar) --}}
        <div class="grid lg:grid-cols-3 gap-10 items-start">

            {{-- BAGIAN KIRI: Daftar Jalur PMB (Mengambil 2 Kolom) --}}
            ...
            {{-- BAGIAN KANAN: Sidebar Hubungi Kami (Mengambil 1 Kolom) --}}
